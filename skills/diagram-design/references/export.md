...
Some hosts may expose a slash command that delegates here, but the standalone Skill must work from the natural-language request and this reference. Do not assume host-specific command files are installed.
